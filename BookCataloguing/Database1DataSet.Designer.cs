...
namespace BookCataloguing {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class bookDataTable : global::System.Data.TypedTableBase<bookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public bookRow AddbookRow(int bid, string bname, string bimgurl) {
            ...
            private void InitClass() {
                ...
                this.columnbimgurl.MaxLength = 10;
            }
...
namespace BookCataloguing.Database1DataSetTableAdapters {
    ...
    public partial class bookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[book] WHERE (([bid] = @Original_bid) AND ((@IsNull_bname = 1 A" +
                "ND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_bimgurl = 1 AN" +
                "D [bimgurl] IS NULL) OR ([bimgurl] = @Original_bimgurl)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[book] ([bid], [bname], [bimgurl]) VALUES (@bid, @bname, @bimgu" +
                "rl);\r\nSELECT bid, bname, bimgurl FROM book WHERE (bid = @bid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[book] SET [bid] = @bid, [bname] = @bname, [bimgurl] = @bimgurl WHERE (([bid] = @Original_bid) AND ((@IsNull_bname = 1 AND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_bimgurl = 1 AND [bimgurl] IS NULL) OR ([bimgurl] = @Original_bimgurl)));
SELECT bid, bname, bimgurl FROM book WHERE (bid = @bid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT bid, bname, bimgurl FROM dbo.book";
        ...
        public virtual int Delete(int Original_bid, string Original_bname, string Original_bimgurl) {
        ...
        public virtual int Insert(int bid, string bname, string bimgurl) {
        ...
        public virtual int Update(int bid, string bname, string bimgurl, int Original_bid, string Original_bname, string Original_bimgurl) {
            ...
            if ((Original_bimgurl == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_bimgurl));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string bname, string bimgurl, int Original_bid, string Original_bname, string Original_bimgurl) {
            return this.Update(Original_bid, bname, bimgurl, Original_bid, Original_bname, Original_bimgurl);
        }
    }
